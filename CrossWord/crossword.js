...
function showCompletionPopup() {
    Swal.fire({
        title: 'Congratulations!',
        html: '<p>You have completed the game!</p><p>Fill out the form for an additional lottery chance.</p>',
        icon: 'success',
        width: '80%',
...
function goToMainPage() {
    window.location.href = "../mainpage.html"; // 确保该路径正确
}
...
// 当游戏完成时调用 showCompletionPopup 函数
// 确保在游戏逻辑中检测到完成状态时调用此函数，例如
